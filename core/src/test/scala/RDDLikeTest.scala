...
class RDDLikeTest extends FlatSpec {
  ...
  val data = List(
    """ { "keyA": 1, "keyB": "stringA", "keyC": true, "keyD": 20000, "keyE": 10.10101, "keyF": {"m1": 1, "m2": 2, "m3": 3} } """,
    """ { "keyA": 2, "keyB": "stringB", "keyC": false, "keyD": 40000, "keyE": 101.010101, "keyF": {"m1": 11, "m2": 12, "m3": 13} } """
  )
